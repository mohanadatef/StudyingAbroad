...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        @include('includes.admin.error')
            <div align="center">{{ __('Add Description Service') }}</div>
                <form action="{{url('admin/description_service/create')}}" enctype="multipart/form-data" method="POST" style="width: 1000px;margin-left: 50px">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-md-6">
