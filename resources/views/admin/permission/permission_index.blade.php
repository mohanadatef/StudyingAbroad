                                ...
                                @foreach($permission as $mypermission)
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="{{url('admin/permission/delete/'.$mypermission->id)}}" onclick="return confirm('Are you sure?')" style="color: red"> <i class="ace-icon fa fa-trash bigger-120 ">delete</i></a>
                                            @endpermission
                                        </td>
                                    </tr>
                                @endforeach
